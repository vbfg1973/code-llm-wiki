...
public sealed class MethodBodyDependencyUsageProjector : IMethodBodyDependencyUsageProjector
{
    public IReadOnlyDictionary<EntityId, PackageMethodBodyDependencyUsageCatalog> Project(MethodBodyDependencyUsageProjectionRequest request)
    {
                ...
                x =>
                {
                    var namespaces = x
                        ...
                        .Select(ns =>
                        {
                            var types = ns
                                ...
                                .Select(type =>
                                {
                                    var methods = type
                                        ...
                                        .Select(method => new PackageMethodBodyDependencyMethodUsageNode(
                                    ...
                                    return new PackageMethodBodyDependencyTypeUsageNode(
                            ...
                            return new PackageMethodBodyDependencyNamespaceUsageNode(
                    ...
                    return new PackageMethodBodyDependencyUsageCatalog(
