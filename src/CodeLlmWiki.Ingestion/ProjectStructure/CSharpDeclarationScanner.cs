            ...
            switch (member)
            {
                case MethodDeclarationSyntax methodDeclaration:
                {
                    ...
                    discoveredMethods.Add(new MethodDiscoveryNode(
                        ...
                        HasAnalyzableBody: methodDeclaration.Body is not null || methodDeclaration.ExpressionBody is not null,
                ...
                case ConstructorDeclarationSyntax constructorDeclaration:
                {
                    ...
                    discoveredMethods.Add(new MethodDiscoveryNode(
                        ...
                        IsOverride: false,
                        HasAnalyzableBody: constructorDeclaration.Body is not null || constructorDeclaration.ExpressionBody is not null,
